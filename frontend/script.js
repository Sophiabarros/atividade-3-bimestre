...
function criarIngresso(filme) {
    ...
    const acoes = `
        <div class="acoes">
            <a class="botao-claquete" href="editar.html?id=${filme.id}" aria-label="Editar ${titulo}">${ICONE_EDITAR}Editar</a>
            <a class="botao-claquete perigo" href="apagar.html?id=${filme.id}" aria-label="Apagar ${titulo}">${ICONE_APAGAR}Apagar</a>
        </div>
    `
